...
\[
(\mu_1^T \Sigma^{-1} - \mu_2^T \Sigma) x + x^T (\Sigma^{-1} \mu_1 - \Sigma^{-1} \mu_2) + \mu_2^T \Sigma^{-1} \mu_2 - \mu_1^T \Sigma^{-1} \mu_1 = v
\]
If we let
\[
...
\]
If we let $m_1 = \mu_0 \Sigma^{-1}$ and $m_2 = \Sigma^{-1} \mu_0$ then we have
\[
m_1 x + x^T m_2 - u = 0
\]
This is the same as
